<template>
  <div class="vist-userInfo">
      <view class="section">  
        <textarea :value="getVisitFont" maxlength="150" @input="textareaChange"/>
        <span style="display:block;width:100%;text-align:right">{{remnant}}/150</span>
      </view>  
      <div class="imgChange">
        <ul style="overflow:hidden">
          <li v-for="(item,index) in pics" :key="index">
            <img :src="item" :class="{hidden:index == selectedPics}">
          </li>
          <li @click="changeImg()">
